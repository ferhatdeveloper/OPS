// Dosya Adı: ewaybill_status_queue_test.dart
// Açıklama: e-İrsaliye durum dens ETTN/GİB satır smoke
...
void main() {
  ...
  testWidgets('EwaybillStatusScreen dens ETTN/GİB alanları', (tester) async {
    await pumpStubWithL10n(
      tester,
      EwaybillStatusScreen(records: EwaybillStatusSeed.defaultRows),
    );
    expectStubL10nSmoke(tester, 'field_sales.stubs.ewaybill_status');
    ...
    final sales = EwaybillStatusSeed.salesRows;
